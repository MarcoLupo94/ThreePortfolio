...
export const projects = [
    {
        ...
        urL: 'https://topfolio.herokuapp.com/lupo.marco94-portfolio',
        technologies: [
    ...
    },
    {
        ...
        name: 'Goods4Good',
        description:
            'A web application that helps people find and donate to charitable causes, designed to be accessible and easy to use on any device.s',
